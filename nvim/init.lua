...
require('lazy').setup({
  ...
  -- Fuzzy Finder (files, lsp, etc)
  {
    ...
    keys = {
      ...
      { "<leader>fg",       "<cmd> Telescope live_grep <cr>",            desc = "[Telescope] Find word" },
      ...
      { "<leader><leader>", "<cmd> Telescope resume <cr>",               desc = "[Telescope] Find last search" },
      { "<leader>fF",       "<cmd> Telescope file_browser <cr>",         desc = "[Telescope] Find file broswer" },
    },
    extensions = {
      file_browser = {
        theme = "ivy",
  ...
  -- Diagnostics, References, Telescope, Quickfix, Loclist UI
  {
    "folke/trouble.nvim",
  ...
  -- Highlight words under cursor via LSP, Treesitter, Regex
  -- {
...
dofile(vim.api.nvim_get_runtime_file("options.lua", false)[1])
dofile(vim.api.nvim_get_runtime_file("commands.lua", false)[1])
dofile(vim.api.nvim_get_runtime_file("keymaps.lua", false)[1])
